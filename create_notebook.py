...
notebook = {
    "cells": [
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "helper_functions_code"},
            "outputs": [],
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "podcast_downloader"},
            "source": [
                "## 📥 Podcast Downloader"
            ]
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "podcast_downloader_widgets"},
            "outputs": [],
            "source": [
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "podcast_downloader_functions"},
            "outputs": [],
            "source": [
                "def load_feed(b):\n",
                "    \"\"\"Lädt RSS-Feed und zeigt Folgen an\"\"\"\n",
                "    global episode_data\n",
                "    \n",
                "    feed_url = feed_url_widget.value\n",
                "    download_dir = download_dir_widget.value\n",
                "    \n",
                "    # Erstelle Zielordner\n",
                ...
                "                file_exists = os.path.exists(os.path.join(download_dir, filename))\n",
                "                \n",
                "                # Erstelle Checkbox\n",
                "                checkbox = widgets.Checkbox(\n",
                "                    value=not file_exists,\n",
                "                    description=f\"{title} ({size_mb} MB)\" + (\" ✅\" if file_exists else \"\"),\n",
                "                    layout=widgets.Layout(width='800px')\n",
                "                )\n",
                "                checkboxes.append(checkbox)\n",
                "        \n",
                "        # Update Checkbox-Container\n",
                "        episode_checkboxes.children = checkboxes\n",
                "        \n",
                "        print(f\"✅ {len(episode_data)} Folgen gefunden!\")\n",
                "        \n",
                "    except Exception as e:\n",
                "        print(f\"❌ Fehler beim Laden des Feeds: {e}\")\n",
                "\n",
                "def download_episodes(b):\n",
                "    \"\"\"Lädt ausgewählte Folgen herunter\"\"\"\n",
                "    global episode_data\n",
                "    \n",
                "    download_dir = download_dir_widget.value\n",
                "    \n",
                "    # Sammle ausgewählte Folgen\n",
                "    selected_episodes = []\n",
                "    for i, checkbox in enumerate(episode_checkboxes.children):\n",
                "        if checkbox.value and i < len(episode_data):\n",
                "            selected_episodes.append(episode_data[i])\n",
                "    \n",
                "    if not selected_episodes:\n",
                "        print(\"⚠️ Keine Folgen ausgewählt!\")\n",
                "        return\n",
                "    \n",
                "    print(f\"⬇️ Starte Download von {len(selected_episodes)} Folgen...\")\n",
                "    \n",
                "    for idx, episode in enumerate(selected_episodes):\n",
                "        filename = os.path.join(download_dir, episode['filename'])\n",
                "        \n",
                "        if os.path.exists(filename):\n",
                "            print(f\"⏭️ {episode['title']} existiert bereits, überspringe.\")\n",
                "        else:\n",
                "            print(f\"⬇️ Lade: {episode['title']}\")\n",
                "            try:\n",
                ...
                "                            f.write(chunk)\n",
                "                print(f\"✅ Gespeichert: {episode['filename']} ({episode['size_mb']} MB)\")\n",
                "            except Exception as e:\n",
                "                print(f\"❌ Fehler beim Download von {episode['title']}: {e}\")\n",
                "    \n",
                "    print(f\"\\n🎉 Download abgeschlossen! {len(selected_episodes)} Folgen verarbeitet.\")\n",
                "\n",
                "# Event-Handler verbinden\n",
                "load_feed_button.on_click(load_feed)\n",
                "download_button.on_click(download_episodes)\n",
                "\n",
                "print(\"✅ Podcast Downloader Widgets erstellt!\")"
            ]
        },
        {
            "cell_type": "markdown",
            "metadata": {"id": "audio_transkriptor"},
            "source": [
                "## 📝 Audio Transkriptor"
            ]
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "transkriptor_widgets"},
            "outputs": [],
            "source": [
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "transkriptor_functions"},
            "outputs": [],
            "source": [
                "# Globale Variable für das Whisper-Modell\n",
                "whisper_model = None\n",
                "\n",
                ...
                "    \n",
                "    model_size = model_size_widget.value\n",
                "    \n",
                "    print(f\"🤖 Lade Whisper {model_size} Modell...\")\n",
                "    \n",
                "    try:\n",
                "        whisper_model = whisper.load_model(model_size)\n",
                "        model_status.value = f\"<span style='color: green;'>✅ {model_size} Modell geladen</span>\"\n",
                "        print(f\"✅ {model_size} Modell erfolgreich geladen!\")\n",
                "        \n",
                ...
                "            print(f\"📊 Modell-Info: {info['size']} | {info['ram']} RAM | {info['speed']} | {info['accuracy']}\")\n",
                "        \n",
                "    except Exception as e:\n",
                "        model_status.value = f\"<span style='color: red;'>❌ Fehler: {str(e)}</span>\"\n",
                ...
                "    \n",
                "    print(\"📁 Bitte wählen Sie eine Audio-Datei aus...\")\n",
                "    \n",
                ...
                "        return\n",
                "    \n",
                "    # Verarbeite die erste hochgeladene Datei\n",
                ...
                "            print(f\"   • Sprache: {result.get('language', 'Unbekannt')}\")\n",
                "        \n",
                "        # Erstelle Download-Link für Transkription\n",
                "        original_filename = os.path.splitext(filename)[0]\n",
                "        output_filename = f\"{original_filename}.txt\"\n",
                "        with open(output_filename, 'w', encoding='utf-8') as f:\n",
                "            f.write(transcription_text)\n",
                "        \n",
                "        print(f\"\\n💾 Transkription gespeichert als: {output_filename}\")\n",
                "        display(create_download_link(output_filename, \"⬇️ Transkription herunterladen\"))\n",
                "        \n",
                "    except Exception as e:\n",
                ...
                "\n",
                "print(\"✅ Audio Transkriptor Widgets erstellt!\")"
            ]
        },
        {
            "cell_type": "markdown",
            "metadata": {"id": "batch_transcription"},
            "source": [
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "batch_transcription_widgets"},
            "outputs": [],
            "source": [
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "batch_transcription_functions"},
            "outputs": [],
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "tips_and_troubleshooting"},
            "source": [
...
with open('podcast_parser_transkriptor.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=1, ensure_ascii=False)

print("✅ Jupyter Notebook erfolgreich erstellt: podcast_parser_transkriptor.ipynb") 